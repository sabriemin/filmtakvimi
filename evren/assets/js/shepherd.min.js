...
(function (E, Y) {
  "object" === typeof exports && "undefined" !== typeof module
    ...
    : "function" === typeof define && define.amd
      ? define(Y)
      : ((E = "undefined" !== typeof globalThis ? globalThis : E || self), (E.Shepherd = Y()));
})(this, function () {
  function E(a, b) {
    return !1 !== b.clone && b.isMergeableObject(a) ? S(Array.isArray(a) ? [] : {}, a, b) : a;
  }
  function Y(a, b, c) {
  ...
  function pb(a, b, c) {
    ...
    c.isMergeableObject(a) &&
      Fa(a).forEach(function (b) {
        d[b] = E(a[b], c);
      });
    Fa(b).forEach(function (e) {
      if (!Ga(a, e) || (Object.hasOwnProperty.call(a, e) && Object.propertyIsEnumerable.call(a, e)))
        if (Ga(a, e) && c.isMergeableObject(b[e])) {
          if (c.customMerge) {
            var f = c.customMerge(e);
            f = "function" === typeof f ? f : S;
          } else f = S;
          d[e] = f(a[e], b[e], c);
        } else d[e] = E(b[e], c);
    });
  ...
  function sb(a) {
    ...
    if (b) {
      ...
      if (void 0 === c || e)
        e
          ? (e.addEventListener(b, d), a.on("destroy", () => e.removeEventListener(b, d)))
          : (document.body.addEventListener(b, d, !0),
            a.on("destroy", () => document.body.removeEventListener(b, d, !0)));
      else
        return console.error(`No element was found for the selector supplied to advanceOn: ${c}`);
  ...
  function ja(a) {
    return "html" === x(a) ? a : a.assignedSlot || a.parentNode || a.host || G(a);
  }
  function Ja(a) {
    if (!B(a) || "fixed" === F(a).position) return null;
    if ((a = a.offsetParent)) {
      var b = G(a);
      if ("body" === x(a) && "static" === F(a).position && "static" !== F(b).position) return b;
    }
    return a;
  }
  function ba(a) {
    for (
      var b = z(a), c = Ja(a);
      c && 0 <= ["table", "td", "th"].indexOf(x(c)) && "static" === F(c).position;

    )
      c = Ja(c);
    if (c && "body" === x(c) && "static" === F(c).position) return b;
    if (!c)
      a: {
        for (a = ja(a); B(a) && 0 > ["html", "body"].indexOf(x(a)); )
          if (
            ((c = F(a)),
            "none" !== c.transform ||
              "none" !== c.perspective ||
  ...
  function Ka(a) {
    return Object.assign(Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }), a);
  }
  function La(a, b) {
  ...
  function Ma(a) {
    ...
    if (m) {
      ...
      "left" === e && ((p = "right"), (a -= A.clientWidth - d.width), (a *= k ? 1 : -1));
    }
    ...
    return Object.assign(
      Object.assign({}, c),
      {},
      ((b = {}), (b[t] = f ? g + "px" : ""), (b[p] = l ? a + "px" : ""), (b.transform = ""), b),
    );
  }
  function ka(a) {
  ...
  function ta(a) {
    return ca(G(a)).left + sa(a).scrollLeft;
  }
  function ua(a) {
    a = F(a);
  ...
  function Oa(a) {
    return 0 <= ["html", "body", "#document"].indexOf(x(a))
    ...
    if ("viewport" === b) {
      ...
      B(b)
        ...
        : ((f = G(a)),
          ...
          (e = -e.scrollTop),
          "rtl" === F(b || a).direction &&
            (f += Math.max(a.clientWidth, b ? b.clientWidth : 0) - d),
          (a = va({ width: d, height: c, x: f, y: e })));
    return a;
  }
  function wb(a) {
    var b = da(ja(a)),
      c = 0 <= ["absolute", "fixed"].indexOf(F(a).position) && B(a) ? ba(a) : a;
    return aa(c)
      ? b.filter(function (a) {
          return aa(a) && Ia(a, c) && "body" !== x(a);
        })
      : [];
  }
  function xb(a, b, c) {
  ...
  function yb(a, b) {
    ...
    var g = f.reduce(function (b, f) {
      b[f] = ea(a, { placement: f, boundary: c, rootBoundary: d, padding: e })[C(f)];
      return b;
    }, {});
  ...
  function Ab(a, b, c) {
    ...
    if (e || (!e && !c)) {
      if ("body" !== x(b) || ua(d))
        f = b !== z(b) && B(b) ? { scrollLeft: b.scrollLeft, scrollTop: b.scrollTop } : sa(b);
  ...
  function Fb(a) {
    var b = a.reduce(function (a, b) {
      ...
      a[b.name] = c
        ? Object.assign(
            Object.assign(Object.assign({}, c), b),
            {},
            {
  ...
  function Hb(a) {
    ...
    return (c = wa({}, c, { modifiers: Array.from(new Set([...c.modifiers, ...b])) }));
  }
  function Wa(a) {
    return Z(a) && "" !== a ? ("-" !== a.charAt(a.length - 1) ? `${a}-` : a) : "";
  }
  function xa(a) {
  ...
  function Ib(a, b) {
    ...
    (a = b.tour && b.tour.options && b.tour.options.defaultStepOptions) && (c = Xa(a, c));
  ...
  function ab() {
    if (!Aa) {
      Aa = !0;
      do {
        for (var a = 0; a < ha.length; a += 1) {
          var b = ha[a];
          N = b;
          b = b.$$;
          if (null !== b.fragment) {
            b.update();
            b.before_update.forEach(U);
            let a = b.dirty;
            b.dirty = [-1];
        ...
        N = null;
        for (ha.length = 0; W.length; ) W.pop()();
        for (a = 0; a < na.length; a += 1) ((b = na[a]), Ba.has(b) || (Ba.add(b), b()));
        na.length = 0;
      } while (ha.length);
  ...
  function I(a, b, c, d, e, f, h = [-1]) {
    ...
    g.ctx = c
      ? c(a, m, (b, c, ...d) => {
          ...
          if (g.ctx && e(g.ctx[b], (g.ctx[b] = d))) {
            ...
            l &&
              (-1 === a.$$.dirty[0] &&
                (ha.push(a), Ca || ((Ca = !0), Kb.then(ab)), a.$$.dirty.fill(0)),
    ...
    b.target &&
      (b.hydrate
        ? ((c = Array.from(b.target.childNodes)), g.fragment && g.fragment.l(c), c.forEach(w))
        : g.fragment && g.fragment.c(),
      b.intro && n(a.$$.fragment),
      L(a, b.target, b.anchor),
      ab());
    N = k;
  }
  function Lb(a) {
  ...
  function gb(a) {
    let b, c;
    b = new Vb({ props: { cancelIcon: a[3], step: a[1] } });
    return {
      c() {
        R(b.$$.fragment);
      },
  ...
  function ib(a) {
    let b, c;
    b = new ac({ props: { descriptionId: a[0], step: a[2] } });
    return {
      c() {
        R(b.$$.fragment);
      },
  ...
  function ec(a) {
    ...
    return {
      ...
      p(a, [k]) {
        ...
        {
          k = [
            (!h || (k & 20 && e !== (e = void 0 !== a[4].options.text ? a[2] : null))) && {
              "aria-describedby": e,
            },
  ...
  function gc(a, b, c) {
    ...
    a.$$.update = () => {
      a.$$.dirty & 16 &&
        (c(5, (t = l.options && l.options.cancelIcon && l.options.cancelIcon.enabled)),
        c(6, (y = l.options && l.options.title)));
    };
    return [
      e,
      p,
  ...
  function ic({ width: a, height: b, x: c = 0, y: d = 0, r: e = 0 }) {
...
Z`;
  ...
  function kc(a, b, c) {
    ...
    function f(a, b, d = 0, e = 0) {
      if (a.getBoundingClientRect) {
        ...
        let { y: h, height: k } = g,
          { x: m, width: y, left: p } = a.getBoundingClientRect();
    ...
    function m(a) {
      let { modalOverlayOpeningPadding: b, modalOverlayOpeningRadius: c } = a.options;
      if (a.target) {
        let d = mb(a.target),
          e = () => {
            t = void 0;
  ...
  var qb = function (a) {
      ...
      if ((b = !!a && "object" === typeof a))
        ((b = Object.prototype.toString.call(a)),
          (b = !("[object RegExp]" === b || "[object Date]" === b || a.$$typeof === lc)));
      return b;
    },
  ...
  var fa = ["top", "bottom", "right", "left"],
    Sa = fa.reduce(function (a, b) {
      return a.concat([b + "-start", b + "-end"]);
    }, []),
    Ra = [].concat(fa, ["auto"]).reduce(function (a, b) {
    ...
    nc = (function (a) {
      ...
      return function (a, b, h) {
        ...
        var g = {
            placement: "bottom",
            orderedModifiers: [],
            options: Object.assign(Object.assign({}, nb), d),
            modifiersData: {},
          ...
          t = {
            ...
            setOptions: function (h) {
              ...
              g.scrollParents = {
                reference: aa(a) ? da(a) : a.contextElement ? da(a.contextElement) : [],
                popper: da(b),
              };
            ...
            forceUpdate: function () {
              if (!p) {
                ...
                if (Va(b, a))
                  for (
                    g.rects = {
                      reference: Ab(b, ba(a), "fixed" === g.options.strategy),
                      popper: qa(a),
                    },
                      g.reset = !1,
                    ...
                    if (!0 === g.reset) ((g.reset = !1), (b = -1));
                      ...
                      c = c.name;
                      "function" === typeof a &&
                        (g = a({ state: g, options: d, name: c, instance: t }) || g);
                    }
              }
            },
            update: Eb(function () {
      ...
      defaultModifiers: [
          ...
          effect: function (a) {
            ...
            e &&
              k.forEach(function (a) {
                a.addEventListener("scroll", c.update, pa);
              });
            f && h.addEventListener("resize", c.update, pa);
            return function () {
              e &&
                k.forEach(function (a) {
                  a.removeEventListener("scroll", c.update, pa);
                });
          ...
          effect: function (a) {
            ...
            return function () {
              Object.keys(b.elements).forEach(function (a) {
                var d = b.elements[a],
                  f = b.attributes[a] || {};
                a = Object.keys(b.styles.hasOwnProperty(a) ? b.styles[a] : c[a]).reduce(function (
                  a,
                  b,
                ) {
                  a[b] = "";
        ...
        },
        {
          ...
          fn: function (a) {
            ...
            a = Ra.reduce(function (a, c) {
              var e = b.rects;
              var f = C(c);
              var h = 0 <= ["left", "top"].indexOf(f) ? -1 : 1,
                k =
                  "function" === typeof d
                    ? d(Object.assign(Object.assign({}, e), {}, { placement: c }))
                    : d;
              e = k[0];
              k = k[1];
              e = e || 0;
            ...
            e = e.y;
            null != b.modifiersData.popperOffsets &&
              ((b.modifiersData.popperOffsets.x += f), (b.modifiersData.popperOffsets.y += e));
            b.modifiersData[c] = a;
          },
        },
        {
          ...
          fn: function (a) {
            ...
            if (!b.modifiersData[a]._skip) {
              ...
              var n = new Map();
              l = !0;
              for (var u = y[0], J = 0; J < y.length; J++) {
                var ia = y[J],
                  q = C(ia),
                  r = "start" === ia.split("-")[1],
              ...
              b.placement !== u &&
                ((b.modifiersData[a]._skip = !0), (b.placement = u), (b.reset = !0));
            }
          },
        ...
        },
        {
          ...
          fn: function (a) {
            ...
            var p = b.modifiersData.popperOffsets,
              ...
              q =
                "function" === typeof k
                  ? k(Object.assign(Object.assign({}, b.rects), {}, { placement: b.placement }))
                  : k;
            k = { x: 0, y: 0 };
            if (p) {
              if (e) {
        ...
        },
        {
          ...
          fn: function (a) {
            ...
            if (d && e) {
              var k = c.modifiersData[a + "#persistent"].padding,
                ...
                g = "y" === h ? "top" : "left",
                l = "y" === h ? "bottom" : "right",
                p = c.rects.reference[f] + c.rects.reference[h] - e[h] - c.rects.popper[f];
          ...
          effect: function (a) {
            ...
            if (null != d) {
              ...
              Ia(b.elements.popper, d) &&
                ((b.elements.arrow = d),
                (b.modifiersData[a + "#persistent"] = {
                  padding: Ka("number" !== typeof c ? c : La(c, fa)),
                }));
            }
          },
          requires: ["popperOffsets"],
        ...
        },
        {
          ...
          fn: function (a) {
            ...
            b.attributes.popper = Object.assign(
              Object.assign({}, b.attributes.popper),
              {},
              { "data-popper-reference-hidden": e, "data-popper-escaped": h },
            );
          },
        },
      ],
  ...
  class ac extends K {
    constructor(a) {
      super();
      I(this, a, Zb, Yb, H, { descriptionId: 1, element: 0, step: 2 });
    }
  }
  class fc extends K {
    constructor(a) {
      ...
      a.exports = {
        polyfill: function () {
          ...
          function m(b, c, d) {
            ...
            k({ scrollable: f, method: u, startTime: e, startX: h, startY: b, x: c, y: d });
          }
          var g = window,
            l = document;
          if (
            !("scrollBehavior" in l.documentElement.style && !0 !== g.__forceSmoothScrollPolyfill__)
          ) {
              ...
              void 0 !== a &&
                (!0 === b(a)
                  ? n.scroll.call(
                      ...
                      void 0 !== a.top ? a.top : void 0 !== c ? c : g.scrollY || g.pageYOffset,
                    )
                  : m.call(
                      g,
                      l.body,
              ...
              if (void 0 !== a)
                if (!0 === b(a)) {
                  ...
                  n.elementScroll.call(
                    this,
                    void 0 !== a.left ? ~~a.left : "object" !== typeof a ? ~~a : this.scrollLeft,
                    void 0 !== a.top ? ~~a.top : void 0 !== c ? ~~c : this.scrollTop,
                  );
                } else
                  ((c = a.left),
                    (a = a.top),
            ...
            p.prototype.scrollBy = function (a, c) {
              void 0 !== a &&
                (!0 === b(a)
                  ? n.elementScroll.call(
                      this,
                      void 0 !== a.left ? ~~a.left + this.scrollLeft : ~~a + this.scrollLeft,
                      void 0 !== a.top ? ~~a.top + this.scrollTop : ~~c + this.scrollTop,
                    )
                  : this.scroll({
            ...
            p.prototype.scrollIntoView = function (a) {
              if (!0 === b(a)) n.scrollIntoView.call(this, void 0 === a ? !0 : a);
                ...
                a !== l.body
                  ? (m.call(this, a, a.scrollLeft + d.left - c.left, a.scrollTop + d.top - c.top),
                    "fixed" !== g.getComputedStyle(a).position &&
                      g.scrollBy({ left: c.left, top: c.top, behavior: "smooth" }))
  ...
  class Ea extends Da {
    ...
    _scrollTo(a) {
      let { element: b } = xa(this);
      T(this.options.scrollToHandler)
    ...
    _setupElements() {
      ...
      this.options.advanceOn && sb(this);
      {
        ...
        this.isCentered() &&
          ((b = document.body),
          this.shepherdElementComponent.getElement().classList.add("shepherd-centered"));
    ...
    _styleTargetElementForStep(a) {
      ...
      b &&
        ...
        !1 === a.options.canClickTarget && b.classList.add("shepherd-target-click-disabled"));
    }
  ...
  class qc extends Da {
    ...
    removeStep(a) {
      ...
      b &&
        b.id === a &&
        ((this.currentStep = void 0), this.steps.length ? this.show(0) : this.cancel());
    }
    show(a = 0, b = !0) {
      if ((a = Z(a) ? this.getById(a) : this.steps[a]))
        (this._updateStateBeforeShow(),
          T(a.options.showOn) && !a.options.showOn()
            ? this._skipStep(a, b)
    ...
    _done(a) {
      ...
      ("cancel" !== a && "complete" !== a) ||
        !this.modal ||
        ((a = document.querySelector(".shepherd-modal-overlay-container")) && a.remove());
    ...
    _setTourID() {
      this.id = `${this.options.tourName || "tour"}--${ya()}`;
    }
  }
